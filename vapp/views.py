...
# receive message > 160 characters
# return texts list of multiple messages
def cut_SMS(message):
...
def add_Numbers(listObject, numberList, createdBy):
    ...
    for number in numberList:
	    ...
	    if numberObject.seller:
                memberStatement = str(identity) + " akuyunze kulukalala luno: " + str(listObject.name) + ". Okuddamu eri bonna, tandika obubaka bwo n'ekigambo '" + str(listObject.name) + "' oba '"+ str(listObject.name) + " omutandisi'"
